...
Route::get('/organization/{volunteerId}/{organizationId}/fill/{reportId}', [App\Http\Controllers\OrganizationReports::class, 'fill'])->middleware('auth')->name('organization.fill')->middleware('isOrganization');
